...
class BatchDefSTContextFuzzyDHondtDirectOptimize(ABatchDefinitionST):
...
if __name__ == "__main__":
    ...
    BatchDefSTContextFuzzyDHondtDirectOptimize.generateAllBatches(InputABatchDefinition())
