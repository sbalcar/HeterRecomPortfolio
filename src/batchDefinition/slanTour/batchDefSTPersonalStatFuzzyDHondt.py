...
class BatchDefSTPersonalStatFuzzyDHondt(ABatchDefinitionST):
...
if __name__ == "__main__":
    ...
    BatchDefSTPersonalStatFuzzyDHondt().generateAllBatches(InputABatchDefinition())