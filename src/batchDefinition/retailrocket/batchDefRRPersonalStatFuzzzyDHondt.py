...
class BatchDefRRPersonalStatFuzzyDHondt(ABatchDefinitionRR):
...
if __name__ == "__main__":
    ...
    BatchDefRRPersonalStatFuzzyDHondt().generateAllBatches(InputABatchDefinition())