...
class BatchSTContextFuzzyDHondtDirectOptimizeINF(ABatchST):

    @classmethod
    def getParameters(cls):
        return BatchSTContextDHondtINF.getParameters()
...
if __name__ == "__main__":
    ...
    BatchSTContextFuzzyDHondtDirectOptimizeINF.generateAllBatches()
