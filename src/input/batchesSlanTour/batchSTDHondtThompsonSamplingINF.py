...
class BatchSTDHondtThompsonSamplingINF(ABatchST):
    ...
    def getParameters():
        ...
        negativeImplFeedback:List[str] = BatchSTDHondtThompsonSamplingINF().getPenalFncs().keys()
        ...
        for selectorIDH in selectorIDs:
            for nImplFeedbackI in negativeImplFeedback:
                ...
                nImplFeedback:APenalization = BatchSTDHondtThompsonSamplingINF().getPenalFncs()[nImplFeedbackI]
