...
def jobNegDHontRoulette1Clk01View00002OStat08HLin1002(batchID:str, divisionDatasetPercentualSize:int, uBehaviour:str, repetition:int):
        ...
        aDescNegDHontRouletteOStat08HLin1002:AggregationDescription = InputAggrDefinition.exportADescNegDHontRoulette(
                InputAggrDefinition.exportAPenaltyToolOStat08HLin1002(AML1MConf.numberOfAggrItems))

        pDescr:Portfolio1AggrDescription = Portfolio1AggrDescription(
                "NegDHontRoulette1Clk01View00002OStat08HLin1002", rIDs, rDescs, aDescNegDHontRouletteOStat08HLin1002)
