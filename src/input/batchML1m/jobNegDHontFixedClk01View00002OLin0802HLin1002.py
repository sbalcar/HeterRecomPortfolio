...
def jobNegDHontFixedClk01View00002OLin0802HLin1002(batchID:str, divisionDatasetPercentualSize:int, uBehaviour:str, repetition:int):
        ...
        aDescNegDHontFixedOLin0802HLin1002:AggregationDescription = InputAggrDefinition.exportADescNegDHontFixed(
                InputAggrDefinition.exportAPenaltyToolOLin0802HLin1002(AML1MConf.numberOfAggrItems))

        pDescr:Portfolio1AggrDescription = Portfolio1AggrDescription(
                "NegDHontFixedClk01View00002OLin0802HLin1002", rIDs, rDescs, aDescNegDHontFixedOLin0802HLin1002)
