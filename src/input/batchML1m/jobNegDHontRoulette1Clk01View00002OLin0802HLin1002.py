...
def jobNegDHontRoulette1Clk01View00002OLin0802HLin1002(batchID:str, divisionDatasetPercentualSize:int, uBehaviour:str, repetition:int):
        ...
        aDescNegDHontRouletteOLin0802HLin1002:AggregationDescription = InputAggrDefinition.exportADescNegDHontRoulette(
                InputAggrDefinition.exportAPenaltyToolOLin0802HLin1002(AML1MConf.numberOfAggrItems))

        pDescr:Portfolio1AggrDescription = Portfolio1AggrDescription(
                "NegDHontRoulette1Clk01View00002OLin0802HLin1002", rIDs, rDescs, aDescNegDHontRouletteOLin0802HLin1002)
