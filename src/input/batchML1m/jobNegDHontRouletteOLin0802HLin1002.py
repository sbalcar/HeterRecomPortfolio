...
def jobNegDHontRouletteOLin0802HLin1002(batchID:str, divisionDatasetPercentualSize:int, uBehaviour:str, repetition:int):

        d = InputsML1MDefinition(divisionDatasetPercentualSize)

        pDescs:List[APortfolioDescription] = [d.pDescNegDHontRouletteOLin0802HLin1002]
        models:List[DataFrame] = [Tools.createDHontModel(d.pDescNegDHontRouletteOLin0802HLin1002.getRecommendersIDs())]
