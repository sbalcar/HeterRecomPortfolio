...
def jobDHontFixedClk01View00002(batchID:str, divisionDatasetPercentualSize:int, uBehaviour:str, repetition:int):
        ...
        pDescr:Portfolio1AggrDescription = Portfolio1AggrDescription(
                "DHontFixedClk01View00002", rIDs, rDescs, InputAggrDefinition.exportADescDHontFixed())
