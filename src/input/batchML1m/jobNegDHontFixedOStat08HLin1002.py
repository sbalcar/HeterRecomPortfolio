...
def jobNegDHontFixedOStat08HLin1002(batchID:str, divisionDatasetPercentualSize:int, uBehaviour:str, repetition:int):

        d = InputsML1MDefinition(divisionDatasetPercentualSize)

        pDescs:List[APortfolioDescription] = [d.pDescNegDHontFixedOStat08HLin1002]
        models:List[DataFrame] = [Tools.createDHontModel(d.pDescNegDHontFixedOStat08HLin1002.getRecommendersIDs())]
