...
def test01():
    ...
    evaluationDict:dict = {EvalToolContext.ARG_USER_ID: 1, EvalToolContext.ARG_RELEVANCE: methodsResultDict}
    evalToolDHondt = EvalToolContext(#{EvalToolDHondt.ARG_LEARNING_RATE_CLICKS: 0.02,EvalToolDHondt.ARG_LEARNING_RATE_VIEWS: 1000}
